...
void print_benchmark(volatile unsigned int *periph_base)
{
    ...
    int bit_depth = 2048;
    int num_byte = 4;
    unsigned int bytes_transferred = (num_byte*bit_depth); // change obviously
    float time_spent = stop_time-start_time; // change obviously
    time_spent = time_spent/125000000;
...
// first, get a pointer to the peripheral base address using /dev/mem and the function mmap
    ...
    printf("\r\n\r\n\r\nLab 10 Derin Araci - Custom Peripheral Demonstration\n\r");
